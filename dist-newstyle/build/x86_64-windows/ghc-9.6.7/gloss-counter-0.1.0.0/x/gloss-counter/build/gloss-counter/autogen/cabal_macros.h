...
/* package gloss-counter-0.1.0.0 */
#ifndef VERSION_gloss_counter
#define VERSION_gloss_counter "0.1.0.0"
#endif /* VERSION_gloss_counter */
#ifndef MIN_VERSION_gloss_counter
#define MIN_VERSION_gloss_counter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_gloss_counter */
...
#define CURRENT_COMPONENT_ID "gloss-counter-0.1.0.0-inplace-gloss-counter"
